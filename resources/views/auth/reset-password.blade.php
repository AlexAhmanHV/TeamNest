<x-guest-layout>
    ...
    <form method="POST" action="{{ route('password.store') }}" class="space-y-4">
        ...
        <div>
            ...
            <x-text-input id="email" class="mt-1 block w-full border-slate-600 bg-slate-900 text-slate-100" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" />
        ...
        <div class="pt-2 flex justify-end">
            <x-primary-button class="bg-cyan-600 hover:bg-cyan-500 focus:bg-cyan-500">Reset password</x-primary-button>
        </div>
    </form>
</x-guest-layout>
